...
import org.openapitools.model.CourseConfigInner;
...
public class RunConfig {
  ...
  @Valid
  private List<@Valid CourseConfigInner> courseConfig = new ArrayList<>();
  ...
  */
  ...
  public RunConfig courseConfig(List<@Valid CourseConfigInner> courseConfig) {
    this.courseConfig = courseConfig;
    return this;
  }

  public RunConfig addCourseConfigItem(CourseConfigInner courseConfigItem) {
  ...
  */
  ...
  public List<@Valid CourseConfigInner> getCourseConfig() {
    return courseConfig;
  }

  public void setCourseConfig(List<@Valid CourseConfigInner> courseConfig) {
    this.courseConfig = courseConfig;
  }
